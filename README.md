...
- **Frameworks:** Python 3.10, FastAPI, Scikit-learn, Jinja2
- **Data & Storage:** MongoDB Atlas, AWS S3
- **Containerization & Cloud:** Docker, AWS ECR, AWS EC2
- **CI/CD Automation:** GitHub Actions (Self-hosted runner with Systemd)
